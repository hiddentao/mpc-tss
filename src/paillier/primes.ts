...
//   console.log("tryBlumPrime iteration")
...
export class PaillierPrimes {
  ...
  public static async generate(): Promise<PaillierPrimes> {
    const [p, q] = await Promise.all([
      findValidBlumPrime(),
      findValidBlumPrime(),
    ])
    return new PaillierPrimes(p, q)
  }
}
